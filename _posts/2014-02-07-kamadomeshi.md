...
3. 中パッパ状態で10～15分、沸騰が激しくなると 「ジュウジュウ」と音を立て、中身が吹き出す。 この音を合図にまだ燃えていない薪を引いて燠火だけにする。この辺までは蓋を取って確かめてもいい。<br><br>追記(2016/10/3)：グラグラと激しく沸騰したかどうかのタイミングが重要なので、ここまでは蓋を開けたままにしておくという方にお会いしました。その方は、このタイミングで、お米をシャモジでひと混ぜして火の通りを均一にしてから蓋をしていました。<br>
